...
WORKSHEET_PATH = "results/raw/manual_sta_worksheets/sample_3.json"

OUTPUT_DIR = "results/raw/manual_attacks/sample3_replacements"
...
print()
print("=" * 90)
print("SAMPLE 3 — TARGETED WORD SUBSTITUTION ATTACK")
print("=" * 90)
...
def get_actual_word_span(text, raw_start, raw_end):
    ...
    while (
        ...
        and text[trailing_start - 1].isspace()
    ):
        trailing_start -= 1
...
for target in TARGETS:
    ...
    try:
        ...
        if (
            ...
            raise RuntimeError(
                "Alphabetic character immediately "
                "before actual word."
            )
...
for target in validated_targets:
    ...
    for replacement in target["replacements"]:
        ...
        try:
            ...
            # ------------------------------------------------
            # DO NOT ABORT THE WHOLE EXPERIMENT
            # ------------------------------------------------
...
print()
print("=" * 90)
print("SAMPLE 3 — FINAL ATTACK REPORT")
print("=" * 90)
...
print()
print("[✓ SAMPLE 3 ATTACK COMPLETE]")
