...
OUTPUT_PATH = 'results/raw/manual_attacks/optimal_simultaneous_attack_sample3.json'

TOP_K_DELETIONS = 5
TOP_K_INSERTIONS = 5

SAMPLE_3_SUBSTITUTIONS = [
...
def run_sample3():
    print("=" * 70)
    print("RUNNING STANDALONE ATTACK OPTIMIZER ON SAMPLE 3")
    print("=" * 70)
    ...
    with open(BASELINE_PATH, 'r') as f:
        baseline_data = json.load(f)[2] # Index 2 corresponding to Sample 3
    ...
    print(f"Sample 3 Original Z-Score: {orig_stats['z']:.4f} | Green Pairs: {orig_stats['green_count']}/{orig_stats['pair_count']}")
    ...
    all_combinations = list(itertools.product(SAMPLE_3_SUBSTITUTIONS, deletions, insertions))
    ...
    print("\nSAMPLE 3 OPTIMAL ATTACK RESULT")
